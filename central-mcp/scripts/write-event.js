...
// Usage: ./write-event.js [EVENT_TYPE] [JSON_DATA]
// ============================================================================
...
import {
  ...
  writeAgentEvent,
  writeSystemEvent
} from '../dist/universal-write.js';

const eventType = process.argv[2];
const eventDataJson = process.argv[3];

if (!eventType || !eventDataJson) {
  console.error('Usage: ./write-event.js [EVENT_TYPE] [JSON_DATA]');
  console.error('');
  ...
  console.error('  ./write-event.js interview \'{"sessionId":"interview-001","eventType":"session_started","eventCategory":"interview","eventActor":"system","eventAction":"Started gap resolution session"}\'');
  process.exit(1);
}
