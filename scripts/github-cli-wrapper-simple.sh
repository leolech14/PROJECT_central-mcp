#!/bin/bash
# github-cli-wrapper-simple.sh - Simple GitHub CLI wrapper functions

echo "🚀 Setting up GitHub CLI wrapper functions..."

# Create simple GitHub CLI wrapper
cat > scripts/github-cli-wrapper-functions.sh << 'EOF'
#!/bin/bash
...
chmod +x scripts/github-cli-wrapper-functions.sh
echo "✅ GitHub CLI wrapper functions created"

# Test the wrapper
echo "🧪 Testing GitHub CLI wrapper..."
source scripts/github-cli-wrapper-functions.sh
agent_repo_status